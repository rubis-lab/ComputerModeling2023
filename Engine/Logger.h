...
public:
    ...
    void _2023_81570_task_read_write_logger(std::string task_name, std::shared_ptr<TaggedData> read_data, std::shared_ptr<DelayedData> write_data);
    void _2023_81570_real_cyber_event_logger(long long time, int job_id, std::string event_type);
};
